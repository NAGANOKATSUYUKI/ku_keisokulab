...
class Detector():
    def __init__(self):
        ...
        sub_cam_depth = rospy.Subscriber("/z/image2movie_infra", Image, self.ImageCallback)
        sub_darknet_bbox = rospy.Subscriber("/darknet_ros/bounding_boxes", BoundingBoxes, self.DarknetBboxCallback)

        # CSVファイルの初期化
        self.csv_file1 = "/home/keisoku/gomi3/detection_data.csv"
        self.csv_file2 = "/home/keisoku/gomi3/detection_count.csv"
        # ディレクトリが存在しない場合は作成
    ...
    def ImageCallback(self, img_msg):
        try:
            ...
            self.save_dir = "/home/keisoku/gomi3"
