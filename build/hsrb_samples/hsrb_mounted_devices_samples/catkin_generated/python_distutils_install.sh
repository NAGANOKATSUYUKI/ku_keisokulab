...
echo_and_run cd "/home/keisoku/catkin_ws/src/hsrb_samples/hsrb_mounted_devices_samples"
...
echo_and_run /usr/bin/env \
    ...
    "/home/keisoku/catkin_ws/src/hsrb_samples/hsrb_mounted_devices_samples/setup.py" \
     \
    build --build-base "/home/keisoku/catkin_ws/build/hsrb_samples/hsrb_mounted_devices_samples" \
    install \
    --root="${DESTDIR-/}" \
